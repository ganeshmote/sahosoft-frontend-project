...
@NgModule({
  declarations: [FooterOneComponent, CategoriesComponent, CopyrightsComponent, InformationComponent, SocialComponent, WhyWeChooseComponent, HeaderOneComponent, SettingComponent, TopbarComponent,NavbarComponent,LeftMenuComponent],
  imports: [
    CommonModule,
    TranslateModule,
    RouterModule
